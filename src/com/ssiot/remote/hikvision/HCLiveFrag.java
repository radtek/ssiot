package com.ssiot.remote.hikvision;
...
public class HCLiveFrag extends BaseFragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.dahua_videolive, container, false); //frag_single_hc_video 
        m_osurfaceView = (SurfaceView) v.findViewById(R.id.view_PlayWindow);//hc_preview
    ...
    private void setBigTitle(View rootView){
        TextView t = (TextView) rootView.findViewById(R.id.video_title);
        t.setText(mTitle);
    }
