...
public class INetSDK
{
	 ...
	 * <tr><td>SDK_DEVSTATE_BACKUP_DEV</td><td>查询备份设备详细信息 </td><td> SDKDEV_BACKUP_LIST </td></tr>
	 ...
	 * @param lLoginID {@link com.company.NetSDK.INetSDK#LoginEx() LoginEx} 或者 {@link com.company.NetSDK.INetSDK#Login() Login}的返回值 
	 * @param nChannelID  通道号
	 * @param dwAlarmType  报警类型,详见宏{@link com.company.NetSDK.FinalVar#EVENT_IVS_ALL EVENT_IVS_ALL}等宏定义
	 ...
	 * @param dwInBufferSize 传送给设备的数据大小
	 * @param szOutBuffer 设备返回给web的数据
	 * @param dwOutBufferSize 返回数据大小
	 * @param pReserved 保留参数
	 * @param waittime 等待时间 
	 * @return true:成功, false:失败
	 * \endif
	 ...
	 * 查询设备日志
	 * @param lLoginID {@link com.company.NetSDK.INetSDK#LoginEx() LoginEx} 或者 {@link com.company.NetSDK.INetSDK#Login() Login}的返回值 
	 * @param pLogBuffer 日志缓冲区,结构体( SDK_LOG_ITEM ) 
	 ...
	 * \else
	 * 获取刻录状态
	 * @param lAttachHandle {@link com.company.NetSDK.INetSDK#AttachBurnState() AttachBurnState}的返回值 
	 * @return true:成功, false:失败
	 * \endif
	 * @see AttachBurnState
	 */
